          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="space-y-4 text-lg text-foreground/80">
                ...
                {/*</p>*/}
                  <span className="font-semibold text-primary">רותם מרציאנו שקדי</span>, מטפלת מזה שנים רבות במגזר הציבורי והפרטי.<br/>
                  מתמחה בטיפול בילדים (טיפול באמצעות משחק), מתבגרים, הדרכת הורים ומבוגרים.<br/>

                  אני מטפלת באוריינטציה דינמית, תוך עמדה אקלקטית המשלבת גישות טיפוליות נוספות, בהתאם לצרכי המטופל ורצונותיו.<br/>

                  בטיפול אני מסייעת לאנשים בכל הגילאים לקיים תהליכי התפתחות וצמיחה, החלמה מכאב וממצוקות חיים שונות, חיזוק הערך העצמי, המיומנויות החברתיות ועוד.<br/>

                  במהלך עבודתי רכשתי ניסיון בטיפול במגוון רחב של התמודדויות, הפרעות נפשיות, טיפול באוטיזם ולקויות התפתחותיות שונות.<br/>

                  בטיפול נוצר מרחב המאפשר מפגש מעמיק עם עצמך בנוכחות האחר. כאשר מפגש שכזה מתקיים בתוך קשר עמוק וקרוב, מתקיימים תהליכי צמיחה, התפתחות והתגברות על קשיים ומצוקות.<br/>

                  במידה ואתה או ילדך סובלים מקושי או אתגר המקשה או מכביד עליכם, אתם מוזמנים לפנות ואנו נברר יחד כיצד אוכל לסייע?
